...
public class Debugger
{
	 ...
	 */
	public Debugger(int numerator, int denominator) {
	 ...
	 */
	public Debugger(String fractionString) {
	 ...
	 */
	public Debugger getReciprocal() {
		return new Debugger(denominator, numerator);
	}
	 ...
	 *         the parameter
	 */
	public Debugger multiply(Debugger that) {
		Debugger product = new Debugger(
	 ...
	 *         the parameter
	 */
	public Debugger divide(Debugger that) {
		Debugger quotient = new Debugger(this.numerator
	 ...
	 *         parameter
	 */
	public Debugger add(Debugger that) {
		int num = (this.numerator * that.denominator)
				+ (this.denominator * that.numerator);
		int den = this.denominator * that.denominator;
		Debugger sum = new Debugger(num, den);
		sum.simplify();
		return sum;
	 ...
	 *         parameter
	 */
	public Debugger subtract(Debugger that) {
		return add(new Debugger(-1 * that.numerator, that.denominator));
	}
